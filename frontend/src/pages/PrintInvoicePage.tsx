...
const Logo = ({ color = '#f58220' }: { color?: string }) => (
  <svg 
    width="120" 
    height="120" 
...
const PrintableInvoice = ({ invoice, settings }: PrintableInvoiceProps) => {
  ...
  const primaryColor = settings?.primary_color || '#f58220'
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.companyInfo}>
          <h2 style={{ margin: '0 0 10px 0', fontSize: '20px', color: primaryColor }}>{companyName}</h2>
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button 
              ...
              style={{ background: settings?.primary_color || '#f58220' }}
            >
